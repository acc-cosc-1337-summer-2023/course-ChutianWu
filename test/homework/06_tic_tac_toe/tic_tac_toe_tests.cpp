...
TEST_CASE("Verify the TicTacToe3 winner is C when board is full and game over") 
{
...
TEST_CASE("Verify the TicTacToe4 winner is C when board is full and game over") 
{
